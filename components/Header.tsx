...
const Kbd: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <kbd className="px-1.5 py-0.5 text-[10px] font-medium text-muted bg-background border border-border rounded">
    {children}
  </kbd>
);
    ...
    <>
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border">
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center gap-6">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-foreground font-bold text-xl tracking-tight">MetricFlow</span>
          </Link>
      ...
      {searchOpen && (
        <div className="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
          ...
          />
          <div className="relative mx-auto mt-24 w-[calc(100%-2rem)] max-w-lg bg-surface border border-border rounded-xl shadow-2xl shadow-black/60 overflow-hidden">
            {/* Input row */}
                    ...
                    <div key={type}>
                      ...
                      {items.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`flex items-center justify-center w-7 h-7 rounded-md border border-border bg-background shrink-0 ${
            ...
            {/* Footer hints */}
            <div className="flex items-center gap-3 px-4 h-9 border-t border-border bg-background/60 text-[10px] text-muted">
